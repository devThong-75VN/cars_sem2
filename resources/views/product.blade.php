...
<div class="mainproduct">
    <div class="container" class="main" ng-controller="ProductController">
        ...
        <div class="row">
            ...
            <div class="col-md-8" style="overflow: hidden;">
                <ul class="allProduct ">
                    <li ng-repeat="car in cars | orderBy: order+prop | filter:{Brand: brand, Year: year, Category:category}">
                        <!-- Begin Modal -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <div class="row">
                                            <div class="col-5" style="overflow: hidden;" data-aos="fade-right"
                                                data-aos-duration="2500">
                                                <div class="img-detail1">
                                                    <img ng-repeat="(key, image) in car.images"
                                                        src="{{url ('/img/image-1.jpg')}}" alt="">
                                                </div>
                                            </div>
                                            <div class="col-7 object-detail" data-aos="fade-left"
                                                data-aos-duration="2500">
                                                <h3 class="tittle">
                                                    <a href="">car.TittleDes</a>
                                                </h3>
                                                <div class="price">
                                                    <span class="old-price">&dollar;car.Price</span>
                                                    <span class="new-price">&dollar;car.Price</span>
                                                </div>
